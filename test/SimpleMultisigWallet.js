...
var SimpleMultisigWallet = artifacts.require('../contracts/SimpleMultisigWallet.sol');
...
contract('SimpleMultisigWallet', function(accounts) {
  ...
  it('should send balance to passed address upon death', async function() {
    ...
    let wallet = await SimpleMultisigWallet.new(accounts, ownersRequired, {value: web3.toWei('10', 'ether')});
